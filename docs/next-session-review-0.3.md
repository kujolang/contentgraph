...
- [ ] Run a consented, redacted benchmark campaign on several real 5k–20k page
...
- [ ] Stream large JSON/JSONL artifact serialization directly into the staging
